...
<p align="center">
  ...
  <br>
  <strong>+ Comprehensive Parental Controls</strong>
</p>

<!-- markdownlint-enable MD033 -->

# Pi-hole with Parental Controls

The Pi-hole® is a [DNS sinkhole](https://en.wikipedia.org/wiki/DNS_Sinkhole) that protects your devices from unwanted content without installing any client-side software.

**This fork adds comprehensive parental controls** to block specific services (YouTube, gaming, social media, etc.), manage device access, set time limits, and schedule blocking periods.
...
This fork extends Pi-hole with powerful parental control capabilities:

- **Service-Based Blocking**: Block entire services like YouTube, Minecraft, PlayStation Network, social media platforms, streaming services, and more
- **Device Targeting**: Apply rules to individual devices, groups of devices, or your entire network
- **Time Schedules**: Set blocking schedules for bedtime, school hours, or any custom time period
- **Time Limits**: Enforce daily, weekly, or monthly usage limits
- **Easy Management**: Simple CLI commands integrated into the main `pihole` command
- **Automatic Enforcement**: Background scheduler daemon handles all time-based controls

See **[PARENTAL_CONTROLS_README.md](PARENTAL_CONTROLS_README.md)** for complete documentation, usage examples, and installation instructions.
